...
export const INTENT_CATALOG: IntentMeta[] = [
  ...
  {
    id: 'interaction:short-answer',
    shortName: 'short-answer',
    name: 'Respuesta Corta',
    category: 'interaction',
    description: 'Respuesta de texto validada por keywords, regex o exacta',
    icon: 'message-square',
    defaultProps: {
  ...
  },
  {
    ...
    name: 'Checklist',
    category: 'interaction',
    description: 'Lista de verificación con criterios autocorregibles',
    icon: 'check-square',
    defaultProps: {
      intent: 'interaction:checklist',
      title: '¿Completaste los pasos?',
      instruction: 'Marca los pasos que hayas completado',
      items: [
        { id: '1', text: 'Leí el enunciado completo', required: true },
        { id: '2', text: 'Identifiqué los datos del problema', required: true },
        { id: '3', text: 'Hice un dibujo o esquema', required: false },
      ],
      xpReward: 10,
      showMascot: true,
    },
  ...
  {
    id: 'interaction:rubric',
    shortName: 'rubric',
    name: 'Rúbrica',
    category: 'interaction',
    description: 'Autoevaluación con rúbrica multicriteria',
    icon: 'star',
    defaultProps: {
      intent: 'interaction:rubric',
      title: 'Autoevalúa tu trabajo',
      instruction: 'Evalúa cada criterio según tu desempeño',
      criteria: [
        {
          id: 'clarity',
          name: 'Claridad',
          ...
          levels: [
            { score: 3, label: 'Excelente', description: 'Muy claro y organizado' },
        ...
        },
        {
          id: 'completeness',
          name: 'Completitud',
          description: 'Incluye todos los elementos requeridos',
          levels: [
            { score: 3, label: 'Completo', description: 'Todo incluido' },
            { score: 2, label: 'Parcial', description: 'Falta algo menor' },
            { score: 1, label: 'Incompleto', description: 'Faltan elementos' },
          ],
        },
      ],
      passingScore: 4,
  ...
  {
    id: 'interaction:code-validator',
    shortName: 'code-validator',
    name: 'Validador de Código',
    category: 'interaction',
    description: 'Desafío de programación con tests automáticos',
    icon: 'code-2',
    defaultProps: {
      ...
      testCases: [
        ...
        { id: '2', name: 'Con cero', input: '[0, 5]', expectedOutput: '5' },
        { id: '3', name: 'Negativos', input: '[-1, 1]', expectedOutput: '0', hidden: true },
      ],
      timeout: 5000,
      xpReward: 25,
      showMascot: true,
