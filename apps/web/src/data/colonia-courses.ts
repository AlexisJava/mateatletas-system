...
export const COURSES: Course[] = [
  ...
  {
    id: 'mat-aventura-espacial',
    name: 'Aventura Matemática Espacial',
    area: 'Matemática',
    ageRange: '6-7',
    dayOfWeek: 'Jueves',
    timeSlot: '10:30-12:00',
    description: 'Viaja por el espacio mientras dominas las operaciones básicas. Perfecto para iniciar primer grado.',
    instructor: 'Gimena',
    color: '#10b981',
    icon: '🚀',
  },
...
export const COURSE_DETAILS_MAP: Record<string, CourseDetails> = {
  ...
  'mat-aventura-espacial': {
    temario: [
      'Semana 1: Despegue - Conteo y números hasta 100',
      'Semana 2: Planetas del Sistema Solar - Sumas básicas',
      'Semana 3: Asteroides Peligrosos - Restas simples',
      'Semana 4: Estación Espacial - Sumas y restas combinadas',
      'Semana 5: Alienígenas Amistosos - Introducción a la multiplicación',
      'Semana 6: Galaxias Lejanas - Tablas del 2 y del 5',
      'Semana 7: Agujero Negro - División básica',
      'Semana 8: Regreso a la Tierra - Integración de todos los conceptos',
    ],
    objetivos: [
      'Dominar sumas y restas hasta el 100',
      'Introducción amigable a multiplicación y división',
      'Desarrollar confianza con los números',
      'Preparación sólida para primer grado',
    ],
    metodologia: 'Aventura espacial interactiva. Cada clase es una nueva misión espacial donde resolvemos problemas matemáticos para avanzar. Usamos animaciones, juegos y actividades prácticas. Los niños se convierten en astronautas exploradores.',
    requisitos: [
      'Computadora con conexión a internet',
      'Google Meet (acceso desde el navegador)',
      'Cuaderno y lápiz de colores',
      'Edad: 6-7 años',
      'No requiere conocimientos previos',
    ],
  },
