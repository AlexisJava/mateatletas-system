          ...
          <div className="relative p-6">
            ...
            <div className="mt-4 p-4 rounded-xl bg-indigo-500/10 border border-indigo-500/30">
              <p className="text-sm text-indigo-100 leading-relaxed">
                🔭 <strong>MISIÓN:</strong> Eres astrónomo junior en un observatorio espacial. Debes
                calcular distancias estelares, órbitas planetarias y velocidades de asteroides para
                completar misiones espaciales y proteger la Tierra de amenazas cósmicas.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="text-center py-12">
      ...
      <div className="inline-block px-6 py-3 rounded-xl bg-slate-800 border border-slate-700">
        <p className="text-sm text-slate-400">Próximamente: Simulador interactivo astronómico</p>
      </div>
    </div>
  );
}
