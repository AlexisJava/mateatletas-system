          ...
          <div className="relative p-6">
            ...
            <div className="mt-4 p-4 rounded-xl bg-teal-500/10 border border-teal-500/30">
              <p className="text-sm text-teal-100 leading-relaxed">
                🧪 <strong>MISIÓN:</strong> Eres aprendiz de un laboratorio secreto. Debes aprender
                a crear compuestos siguiendo recetas exactas, balanceando proporciones y gestionando
                inventarios para salvar a la ciudad de una crisis química.
              </p>
            </div>
          </div>
        </div>
  ...
  return (
    <div className="text-center py-12">
      ...
      <div className="inline-block px-6 py-3 rounded-xl bg-slate-800 border border-slate-700">
        <p className="text-sm text-slate-400">Próximamente: Simulador interactivo</p>
      </div>
    </div>
  );
}
