...
export async function listarPlanificaciones(
  ...
  try {
    ...
    return response as PlanificacionSimple[];
  } catch (error) {
...
export async function obtenerDetallePlanificacion(
  ...
  try {
    ...
    return response as DetallePlanificacion;
  } catch (error) {
...
export async function asignarPlanificacion(
  ...
  try {
    ...
    return response as AsignacionPlanificacion;
  } catch (error) {
...
export async function obtenerProgreso(codigo: string): Promise<{
  ...
  try {
    ...
    return response as { progreso: ProgresoEstudiante | null; semanasActivas: number[] };
  } catch (error) {
...
export async function avanzarSemana(
  ...
  try {
    ...
    return response as { success: boolean; nueva_semana: number };
  } catch (error) {
...
export async function registrarTiempo(
  ...
  try {
    ...
    return response as { success: boolean; tiempo_total: number };
  } catch (error) {
...
export async function activarSemana(
  ...
  try {
    ...
    return response as SemanaActiva;
  } catch (error) {
