    ...
    <div className="h-full grid grid-cols-1 md:grid-cols-2 gap-4 overflow-y-auto">
          ...
          <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Comunícate con nosotros directamente por WhatsApp</p>
                <a
          ...
          <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Envíanos un correo electrónico</p>
                <a
          ...
          <div className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                ...
                <p className="text-sm text-gray-600 mb-2">Llamanos de lunes a viernes de 9:00 a 18:00</p>
                <a
      ...
      <div className="bg-white rounded-xl shadow-lg border-2 border-gray-300 p-6">
        ...
        <div className="space-y-3">
          <details className="bg-gray-50 rounded-xl p-4 border-2 border-gray-200 group">
      ...
      <div className="bg-white rounded-xl shadow-lg border-2 border-gray-300 p-6">
        ...
        <div className="space-y-3">
          <button className="w-full bg-gray-50 rounded-xl p-4 border-2 border-gray-200 hover:border-indigo-300 transition-all text-left">
            <div className="flex items-start gap-3">
              <div className="bg-red-100 rounded-lg p-2">
                <Video className="w-5 h-5 text-red-600" />
              </div>
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 mb-1">Videos Tutoriales</h3>
          ...
          <button className="w-full bg-gray-50 rounded-xl p-4 border-2 border-gray-200 hover:border-indigo-300 transition-all text-left">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 mb-1">Guía para Padres</h3>
                <p className="text-sm text-gray-600">Manual completo de uso</p>
              </div>
            </div>
          </button>
          ...
          <button className="w-full bg-gray-50 rounded-xl p-4 border-2 border-gray-200 hover:border-indigo-300 transition-all text-left">
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1">
                <h3 className="font-bold text-gray-900 mb-1">Comunidad de Padres</h3>
                <p className="text-sm text-gray-600">Únete a nuestro grupo de WhatsApp</p>
              </div>
            </div>
          </button>
        </div>
