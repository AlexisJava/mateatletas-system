...
export function EjecutarActividadView({ config, estudiante }: EjecutarActividadViewProps) {
  ...
  const totalPreguntas = contenidoEjercicio ? contenidoEjercicio.preguntas.length : 0;
  ...
  const renderContenido = () => {
    switch (actividad.contenido.tipo) {
      ...
      case 'evaluacion': {
        ...
        return (
          <div className="w-full">
            ...
            >
              <span
                className="text-xl sm:text-2xl font-black text-cyan-300"
                style={{
      ...
      case 'juego': {
        // TODO: Clase sincrónica de química será redefinida desde cero
        ...
        // Placeholder para todos los juegos (incluyendo clase-sincronica-quimica-v1)
        return (
          <div className="text-center">
            <div className="text-7xl sm:text-9xl mb-4 sm:mb-6">🎮</div>
            <h3
              className="text-3xl sm:text-4xl font-black text-white mb-3 sm:mb-4"
              style={{
  ...
  return (
    ...
    >
        ...
        <div className="flex-1 ml-4 sm:ml-6 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div>
              ...
              <p
                className="text-[10px] sm:text-xs font-black uppercase text-cyan-300 mt-1"
                style={{
          ...
          {contenidoEjercicio && (
            <div className="flex items-center gap-3 sm:gap-4">
              <div className="bg-black/40 border-3 sm:border-4 border-black rounded-lg sm:rounded-xl px-3 sm:px-4 py-1.5 sm:py-2">
                <span
      ...
      <div className="flex-1 h-[calc(100vh-5rem)] sm:h-[calc(100vh-6rem)] flex items-center justify-center p-4 sm:p-8 overflow-y-auto">
        {renderContenido()}
      </div>
