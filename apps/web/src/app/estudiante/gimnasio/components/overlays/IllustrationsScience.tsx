  ...
  return (
    ...
    >
      ...
      <g filter={isActive ? 'url(#glow-chem)' : undefined}>
        ...
        <rect x="82" y="40" width="25" height="4" rx="2" fill="rgba(255, 255, 255, 0.4)" />
  ...
  return (
    ...
    >
      ...
      <g filter={isActive ? 'url(#glow-astro)' : undefined}>
        ...
        <circle cx="158" cy="58" r="10" fill="#3b82f6" opacity={isActive ? 0.8 : 0.4} />
        <circle cx="158" cy="58" r="7" fill="#60a5fa" opacity={isActive ? 0.6 : 0.3} />
        ...
        {isActive && (
          <g>
            ...
            <motion.text
              ...
              transition={{ duration: 8, repeat: Infinity, ease: 'linear' }}
            >
              function <tspan fill="#fbbf24">calcular</tspan>
            ...
            >
              const <tspan fill="#ffffff">resultado</tspan>
              <tspan fill="#22d3ee"> = [];</tspan>
            </motion.text>
            ...
            >
              return <tspan fill="#ffffff">resultado</tspan>
              <tspan fill="#22d3ee">;</tspan>
            </motion.text>
