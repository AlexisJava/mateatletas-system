    ...
    <div className="min-h-screen bg-[#0a0a1a] text-white p-4 md:p-6 lg:p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
          <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-emerald-500 to-teal-600 flex items-center justify-center mb-6 shadow-lg shadow-emerald-500/30">
          ...
          <div className="flex items-center gap-3 px-6 py-4 bg-emerald-900/30 border border-emerald-500/30 rounded-2xl">
