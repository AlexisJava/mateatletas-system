  ...
  return (
    <div className="min-h-screen bg-gray-950 p-6 space-y-8">
      ...
      <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }}>
        <h1 className="text-4xl font-black text-white mb-2">🏆 Tu Gamificación</h1>
        ...
        <div className="lg:col-span-2">
          <div className="bg-gray-900 rounded-2xl p-6">
            <div className="flex items-center justify-between mb-4">
              <h2 className="text-white font-bold text-xl">🎉 Logros Recientes</h2>
              <Link
            ...
            {logrosRecientes && Array.isArray(logrosRecientes) && logrosRecientes.length > 0 ? (
              ...
              <div className="text-center py-8">
                <p className="text-gray-400 mb-4">Aún no has desbloqueado ningún logro</p>
                <Link
      ...
      >
        <h2 className="text-3xl font-black mb-2">🎁 ¿Listo para canjear?</h2>
        <p className="text-white/90 mb-6">
          Usa tus monedas para desbloquear cursos increíbles de ciencia, programación, robótica y
          más
        </p>
        <Link
          href="/estudiante/gimnasio"
      ...
      {/* Todos los logros */}
      <div>
        <h2 className="text-white font-bold text-2xl mb-6">🎯 Todos los Logros</h2>
