  ...
  return (
    <div className="min-h-screen bg-[#030014] text-white relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <FloatingLines
          linesGradient={['#06b6d4', '#0891b2', '#22d3ee']}
          animationSpeed={0.4}
          interactive={false}
          parallax={false}
        />
      ...
      <div className="relative z-10 p-4 md:p-6 lg:p-8">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col items-center justify-center min-h-[60vh] text-center">
            <div className="icon-animate w-24 h-24 rounded-3xl bg-gradient-to-br from-cyan-500 to-blue-600 flex items-center justify-center mb-6 shadow-lg shadow-cyan-500/30">
              <Gamepad2 className="w-12 h-12 text-white" />
            </div>

            <h1 className="title-animate text-3xl sm:text-4xl font-black mb-2">Arcade Zone</h1>
            ...
            <div className="badge-animate flex items-center gap-3 px-6 py-4 bg-cyan-900/30 border border-cyan-500/30 rounded-2xl backdrop-blur-sm">
