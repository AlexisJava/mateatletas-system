...
export function CanalComunicacion() {
  ...
  return (
    <div className="flex-1 min-h-[350px] lg:min-h-0 rounded-2xl bg-gradient-to-br from-violet-950/30 via-[#0f0f1a]/95 to-fuchsia-950/20 backdrop-blur-sm border border-violet-500/20 overflow-hidden flex flex-col shadow-lg shadow-violet-500/5">
      {/* Header */}
      <div className="p-4 border-b border-violet-500/10 flex justify-between items-center shrink-0 bg-gradient-to-r from-violet-500/5 to-transparent">
