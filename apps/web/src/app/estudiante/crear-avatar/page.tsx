              ...
              {timeoutWarning && (
                <div className="absolute inset-0 flex items-center justify-center bg-black/60 backdrop-blur-sm z-[102]">
                  ...
                  >
                    ...
                    <p className="text-yellow-200 font-bold text-xl mb-2 text-center">
                      El editor está tardando mucho...
                    </p>
                    <p className="text-yellow-100 text-sm mb-6 text-center">
                      Puede ser un problema de conexión o del servicio Ready Player Me
                    </p>
