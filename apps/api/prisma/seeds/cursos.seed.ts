...
const cursos = [
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Conviértete en un científico loco y aprende química haciendo experimentos seguros pero asombrosos. Crearemos volcanes, slime, cristales y más.',
    categoria: 'ciencia',
  ...
  },
  {
    ...
    descripcion:
      'Descubre cómo la química moderna nació de la alquimia antigua. Aprende sobre elementos, reacciones químicas y la tabla periódica de forma divertida.',
    categoria: 'ciencia',
    subcategoria: 'quimica',
    duracion_clases: 6,
    nivel_requerido: 2,
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Embárcate en una aventura por el espacio. Visita planetas, aprende sobre estrellas, agujeros negros y la exploración espacial.',
    categoria: 'ciencia',
  ...
  },
  {
    ...
    descripcion:
      'Diseña tu propia misión a Marte. Aprende sobre cohetes, vida en otros planetas y cómo los humanos podrían vivir en Marte algún día.',
    categoria: 'ciencia',
    subcategoria: 'astronomia',
    duracion_clases: 8,
    nivel_requerido: 3,
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Descubre las leyes de Newton mientras construyes catapultas, rampas y experimentos de física. Aprende cómo funcionan las cosas.',
    categoria: 'ciencia',
    subcategoria: 'fisica',
    duracion_clases: 8,
    nivel_requerido: 2,
  ...
  },
  {
    ...
    descripcion:
      'Explora todos los tipos de energía: eléctrica, solar, eólica. Construye circuitos simples y aprende cómo funciona la electricidad.',
    categoria: 'ciencia',
    subcategoria: 'fisica',
    duracion_clases: 10,
    nivel_requerido: 3,
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Aprende a programar creando videojuegos con Scratch. No necesitas experiencia previa. ¡Diseña, programa y juega tus creaciones!',
  ...
  },
  {
    ...
    descripcion:
      'Da tus primeros pasos en Python, uno de los lenguajes más populares. Crea juegos de texto, calculadoras y proyectos divertidos.',
    categoria: 'programacion',
    subcategoria: 'python',
    duracion_clases: 16,
    nivel_requerido: 3,
  ...
  },
  {
    ...
    descripcion:
      'Aprende HTML, CSS y JavaScript básico. Crea tu propia página web desde cero y publícala en internet.',
    categoria: 'programacion',
    subcategoria: 'web',
    duracion_clases: 14,
    nivel_requerido: 4,
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Diseña y construye robots simples con motores y sensores. Aprende cómo funcionan los robots y programa sus movimientos.',
    categoria: 'robotica',
  ...
  },
  {
    ...
    descripcion:
      'Aprende electrónica y programación con Arduino. Crea proyectos increíbles como semáforos, alarmas y sensores.',
    categoria: 'robotica',
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Descubre cómo usamos las matemáticas todos los días: en el supermercado, en deportes, en videojuegos y más.',
  ...
  },
  {
    ...
    descripcion:
      'Usa geometría para diseñar casas, puentes y rascacielos. Aprende cómo los arquitectos usan las matemáticas.',
    categoria: 'matematicas',
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Aprende a modelar objetos en 3D con Tinkercad. Diseña personajes, edificios y objetos para imprimir en 3D.',
    categoria: 'diseno',
    subcategoria: '3d',
    duracion_clases: 12,
    nivel_requerido: 2,
  ...
  },
  {
    ...
    descripcion:
      'Crea animaciones y videos con herramientas digitales. Aprende los fundamentos de la animación frame por frame.',
    categoria: 'diseno',
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Explora el mundo de los seres vivos. Desde células hasta ecosistemas, descubre cómo funciona la vida en la Tierra.',
    categoria: 'ciencia',
  ...
  },
  {
    ...
    descripcion:
      'Descubre cómo funciona el ADN, los genes y la herencia. Aprende por qué te pareces a tu familia.',
    categoria: 'ciencia',
  ...
  // ==========================================
  {
    ...
    descripcion:
      'Curso completo de Python con 40 clases. Desde lo básico hasta proyectos avanzados como apps web, bots y juegos.',
    categoria: 'programacion',
    subcategoria: 'python',
    duracion_clases: 40,
    nivel_requerido: 5,
  ...
  },
  {
    ...
    descripcion:
      'Conviértete en un maestro de la robótica. Construye robots complejos, usa sensores avanzados y compite en desafíos.',
    categoria: 'robotica',
  ...
  },
  {
    ...
    descripcion:
      'Curso completo que combina química, física, biología y astronomía. Experimentos avanzados y proyectos científicos reales.',
    categoria: 'ciencia',
...
export async function seedCursos(prisma: PrismaClient) {
  ...
  const porCategoria = cursos.reduce(
    (acc, curso) => {
