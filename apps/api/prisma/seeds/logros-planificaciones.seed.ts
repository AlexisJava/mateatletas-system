...
export async function seedLogrosPlanificaciones(prisma: PrismaClient) {
  ...
  const logrosPlanificaciones = [
    // ========== LECCIONES (teoría/práctica individual) ==========
    {
      ...
      xpRecompensa: 25,
      criterioTipo: 'leccion_teoria_completada',
      criterioValor: '1',
      icono: '📖',
      rareza: 'comun',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 30,
      criterioTipo: 'leccion_practica_completada',
      criterioValor: '1',
      icono: '⚡',
      rareza: 'comun',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 100,
      criterioTipo: 'lecciones_completadas',
      criterioValor: '10',
      icono: '📚',
      rareza: 'comun',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 150,
      criterioTipo: 'clases_completadas',
      criterioValor: '5',
      icono: '🎓🎓',
      rareza: 'comun',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 35,
      criterioTipo: 'tarea_obligatoria',
      criterioValor: '1',
      icono: '📋',
      rareza: 'comun',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 200,
      criterioTipo: 'tareas_completadas',
      criterioValor: '10',
      icono: '💪',
      rareza: 'raro',
      secreto: false,
    ...
    // ========== PLANIFICACIONES COMPLETAS ==========
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 250,
      criterioTipo: 'planificacion_completada',
      criterioValor: '1',
      icono: '🏆',
      rareza: 'raro',
      secreto: false,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 800,
      criterioTipo: 'planificaciones_completadas',
      criterioValor: '3',
      icono: '🌟🌟🌟',
      rareza: 'epico',
      secreto: false,
    ...
    // ========== VELOCIDAD ==========
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 75,
      criterioTipo: 'clase_tiempo',
      criterioValor: '1800', // 30 minutos en segundos
      icono: '⚡',
      rareza: 'raro',
      secreto: false,
      orden: 140,
    ...
    // ========== SECRETOS ==========
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 100,
      criterioTipo: 'leccion_hora',
      criterioValor: JSON.stringify({ hora_max: 7 }),
      icono: '🌅',
      rareza: 'raro',
      secreto: true,
    ...
    },
    {
      ...
      xpRecompensa: 100,
      criterioTipo: 'leccion_hora',
      criterioValor: JSON.stringify({ hora_min: 23 }),
      icono: '🌙',
      rareza: 'raro',
      secreto: true,
    ...
    },
    {
      ...
      categoria: 'planificaciones',
      xpRecompensa: 150,
      criterioTipo: 'lecciones_fin_semana',
      criterioValor: '5',
      icono: '📚🏠',
      rareza: 'raro',
      secreto: true,
