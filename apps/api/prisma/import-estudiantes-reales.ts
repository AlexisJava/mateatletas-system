...
const estudiantes: EstudianteData[] = [
  // GRUPO B1
  {
    nombre: 'Santiago',
    apellido: 'Sierra',
    profesor: 'Gimena Reniero',
    dia: 'Lunes',
    horario: '19:30',
    grupo: 'B1',
    perfil: 'Base Progresivo',
    tutor: 'Vanesa Elida Reyes',
  },
  {
    nombre: 'Nehuen',
    apellido: 'Besagonill',
  ...
  },
  {
    ...
    grupo: 'B1',
    perfil: 'Base Progresivo',
    tutor: 'Lucia Angelica Morales Diaz',
  },
  {
    nombre: 'Bautista',
    apellido: 'Escobar',
    ...
    grupo: 'B1',
    perfil: 'Base Progresivo',
    tutor: 'Adriana Veronica Bou Khair',
  },
  {
    nombre: 'Ivana',
    apellido: 'Gonzalez',
  ...
  },
  {
    ...
    grupo: 'B1',
    perfil: 'Base Progresivo',
    tutor: 'Ludmila Criniti',
  },

  // GRUPO B2 - Martes 14:30
  {
    nombre: 'Olivia',
    apellido: 'Anfus Basilone',
    profesor: 'Gimena Reniero',
    dia: 'Martes',
    horario: '14:30',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Laura Elizabet Basilone',
  },
  {
    nombre: 'Mora',
    apellido: 'Pacheco',
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Cluadio Dario Pacheco / Elsa Spena',
  },
  {
    nombre: 'Lara',
    apellido: 'Pacheco',
  ...
  },
  {
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Mariano Tessone / Carla Maria Fournier',
  },
  ...
  },
  {
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Efigenia An Di Benedetto',
  },
  {
    nombre: 'Santiago',
    apellido: 'Erbojo',
  ...
  },
  {
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Sabrina Jesica Moschini',
  },
  {
    nombre: 'Lian André',
    apellido: 'Guzman Fuentes',
    profesor: 'Gimena Reniero',
    dia: 'Miercoles',
    horario: '19:30',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Yenisei del Rocio Fuentes Gutierrez',
  },
  {
    nombre: 'Victoria',
    apellido: 'Smerkin',
  ...
  },
  {
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Mauricio German Gori / Carla Fernández',
  },

  // GRUPO B2 - Jueves 19:30
  {
    nombre: 'Andre',
    apellido: 'Santos Garcia',
    profesor: 'Gimena Reniero',
    dia: 'Jueves',
    horario: '19:30',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Ketty Yamina Garcia Acosta',
  },
  {
    nombre: 'Ángel',
    apellido: 'Mañque',
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Florencia Jesica Ostaszewski',
  },
  {
    nombre: 'Rebeca',
    apellido: 'Trujillo Maldonado',
    profesor: 'Gimena Reniero',
    dia: 'Jueves',
    horario: '19:30',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Maria Celeste Maldonado',
  },
  {
    nombre: 'Bastian',
    apellido: 'Fleischer',
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Viviana Alicia Veronica Sulka',
  },
  {
    nombre: 'Antonela',
    apellido: 'Jimenez',
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Santos Briceño Rocio',
  },
  {
    nombre: 'Paula',
    apellido: 'Blanco Rochaix',
    profesor: 'Gimena Reniero',
    dia: 'Jueves',
    horario: '19:30',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Luciana Natalia Rochaix',
  },
  ...
  // GRUPO B2 - Viernes 18:00
  {
    nombre: 'Sofia Lujan',
    apellido: 'Lamas',
    profesor: 'Fabricio Carinelli',
    dia: 'Viernes',
    horario: '18:00',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Azucena Atanasia Salva',
  },
  {
    nombre: 'Barrales Agustín',
    apellido: 'Gastón',
    profesor: 'Fabricio Carinelli',
    dia: 'Viernes',
    horario: '18:00',
  ...
  },
  {
    ...
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Federico Manuel Diaz / Claudia Pincheira',
  },
  {
    nombre: 'Jose',
    apellido: 'Sobrevilla',
  ...
  // GRUPO B3 - Lunes 18:00
  {
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Gabriel Fernando Blasco Porro / Maria Adela reyes',
  },
  {
    nombre: 'Lucio',
    apellido: 'Ronchese',
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Jorge Julian Pepe / Laura Paola Ronchese',
  },
  {
    nombre: 'Mateo',
    apellido: 'Groia',
  ...
  },
  {
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Federico Manuel Diaz / Pincheira Claudia',
  },
  {
    nombre: 'Benjamin',
    apellido: 'Porras',
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Idania Margarita Abarca Zambrano',
  },
  {
    nombre: 'Melina',
    apellido: 'Diaz',
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Diego Dante Diaz / Rita Lujan Raffaele',
  },
  ...
  // GRUPO B3 - Viernes 19:30
  {
    ...
    grupo: 'B3',
    perfil: 'Base Progresivo',
    tutor: 'Patricia Maccari Fugante',
  },
  {
    nombre: 'Adriana',
    apellido: 'Patti',
  ...
  // GRUPO L4 - Miércoles 20:00
  {
    ...
    grupo: 'L4',
    perfil: 'Base Progresivo',
    tutor: 'Graciela Benita Sarapura',
  },
  {
    nombre: 'Geraldin',
    apellido: 'Santos García',
    profesor: 'Fabricio Carinelli',
    dia: 'Miercoles',
    horario: '20:00',
    grupo: 'L4',
  ...
  },
  {
    ...
    grupo: 'L4',
    perfil: 'Base Progresivo',
    tutor: 'Jorgelina Adriana Soledad Perez',
  },
  {
    nombre: 'Ticiana',
    apellido: 'Peña',
  ...
  // GRUPO L1 - Jueves 19:30
  {
    ...
    horario: '19:30',
    grupo: 'L1',
    perfil: 'Lógico Desafiante',
    tutor: 'Montoya Luciana',
  },
  {
    nombre: 'Abril',
    apellido: 'Dondi',
  ...
  },
  {
    ...
    grupo: 'L2',
    perfil: 'Lógico Desafiante',
    tutor: 'Orestes Antonio Safi / Nazarena Bardon',
  },
  {
    nombre: 'Tomás',
  ...
  {
    nombre: 'Pilar',
    apellido: 'Gonzalez Merlo',
    profesor: 'Fabricio Carinelli',
    dia: 'Jueves',
    horario: '18:00',
    grupo: 'L3',
    perfil: 'Lógico Desafiante',
    tutor: 'Carina Eugenia Merlo',
  },
  ...
  // PROGRAMACIÓN - Arduino Con Scratch - Lunes 18:00
  {
    nombre: 'Lucio',
    apellido: 'Long Wong',
    profesor: 'Marcos Reyeros',
    dia: 'Lunes',
    horario: '18:00',
    grupo: 'Arduino Con Scratch',
    perfil: 'Programación',
    tutor: 'Erika Cecil Gaspar Paredes',
  },
  {
    nombre: 'Augusto',
    apellido: 'Carrillo Bascary Rojas',
    profesor: 'Marcos Reyeros',
    dia: 'Lunes',
    horario: '18:00',
    grupo: 'Arduino Con Scratch',
    perfil: 'Programación',
    tutor: 'Laura Cecilia Rojas',
  },
  {
    nombre: 'Facundo',
    apellido: 'Torres Choque',
    profesor: 'Marcos Reyeros',
    dia: 'Lunes',
    horario: '18:00',
    grupo: 'Arduino Con Scratch',
    perfil: 'Programación',
    tutor: 'Lia Ines Torres',
  },
  ...
  // PROGRAMACIÓN - Arduino Con Scratch - Lunes 19:30
  {
    ...
    grupo: 'Arduino Con Scratch',
    perfil: 'Programación',
    tutor: 'Gabriela Adriana Reynoso',
  },
  {
    nombre: 'Esteban',
    apellido: 'Crespo',
  ...
  {
    nombre: 'Ludovico',
    apellido: 'Samperi Durán',
    profesor: 'Marcos Reyeros',
    dia: 'Jueves',
    horario: '18:00',
    grupo: 'Matemáticas + Scratch',
    perfil: 'Programación',
    tutor: 'Maria Delfina Samperi',
  },
  ...
  {
    nombre: 'Bruno',
    apellido: 'Mella Toranzo',
    profesor: 'Marcos Reyeros',
    dia: 'Jueves',
    horario: '19:30',
    grupo: 'Roblox Studio',
    perfil: 'Programación',
    tutor: 'Natalia Soledad Toranzo',
  },
  ...
  // MATEMÁTICAS - Grupo Ayelen - Lunes 19:00
  {
    nombre: 'Theo',
    apellido: 'Ghesla',
    profesor: 'Ayelen Yañez',
    dia: 'Lunes',
    horario: '19:00',
    grupo: 'B2',
    perfil: 'Base Progresivo',
    tutor: 'Estefania Otero',
  },
  {
    nombre: 'Ulises Luis',
    apellido: 'Collar',
  ...
  // MATEMÁTICAS - Grupo L4 Alexis - Lunes 17:00
  {
    nombre: 'Clara',
    apellido: 'Regis',
    profesor: 'Alexis Figueroa',
    dia: 'Lunes',
    horario: '17:00',
    grupo: 'L4',
    perfil: 'Lógico Desafiante',
    tutor: 'Maria Guadalupe Torrado',
  },
  {
    nombre: 'Sofia',
    apellido: 'Salinas',
  ...
  // PROGRAMACIÓN - Videojuegos - Viernes 19:30
  {
    ...
    dia: 'Viernes',
    horario: '19:30',
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Maria Viviana Leal',
  },
  {
    nombre: 'Estefania',
    apellido: 'Matias',
  ...
  },
  {
    ...
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Diego Alejandro Rodriguez',
  },
  {
    nombre: 'Thiago',
    apellido: 'Rodriguez',
  ...
  },
  {
    ...
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Maria Mercedes Escudero',
  },
  {
    nombre: 'Julian Agustin',
    apellido: 'Figueroa',
    profesor: 'Alexis Figueroa',
    dia: 'Viernes',
    horario: '19:30',
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Carolina Alejandra Gonzalez',
  },
  {
    nombre: 'Valentino',
    apellido: 'Gimenez',
    ...
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Silvina Maricel Castañon',
  },
  {
    nombre: 'Giuliana',
    apellido: 'Schenonne',
  ...
  {
    nombre: 'Diego Paolo',
    apellido: 'Colman Gonzalez',
    profesor: 'Alexis Figueroa',
    dia: 'Viernes',
    horario: '19:30',
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Colman Recarte Pablo Edinson',
  },
  {
    nombre: 'Octavio',
    apellido: 'Lensinas',
  ...
  },
  {
    ...
    grupo: 'Programación de videojuegos',
    perfil: 'Programación',
    tutor: 'Griselda Brenda Riquelme',
  },
  ...
  // ASTRONOMÍA - Jueves 18:00
  {
    ...
    grupo: 'Astronomía',
    perfil: 'Divulgación',
    tutor: 'Seoane Fernanda',
  },
  {
    nombre: 'Máximo Nicolas',
    apellido: 'Cal',
    profesor: 'Alexis Figueroa',
    dia: 'Jueves',
    horario: '18:00',
    grupo: 'Astronomía',
    perfil: 'Divulgación',
    tutor: 'Natalia Fernanda Vecchioli',
  },
  ...
  for (const data of estudiantes) {
    try {
      ...
      if (tutoresMap.has(tutorKey)) {
        ...
        const tutorApellido =
          tutorNombres.slice(1).join(' ') || tutorNombres[0];

        // Username: solo nombre.apellido (sin "tutor." ni email)
        const tutorUsername =
          `${tutorNombre.toLowerCase()}.${tutorApellido.toLowerCase().replace(/\s+/g, '.')}`.replace(
            /[^\w.]/g,
            '',
          );
        ...
        const passwordTemporal = Math.floor(
        ...
        tutoresCreados++;
        console.log(
          `  👤 Tutor: ${tutorUsername} (password: ${passwordTemporal})`,
        );
      }

      // 2. CREAR ESTUDIANTE
      const username =
        `${data.nombre.toLowerCase()}.${data.apellido.toLowerCase()}`.replace(
          /\s+/g,
          '.',
        );
      ...
      if (estudiantesMap.has(estudianteKey)) {
        ...
        estudiantesCreados++;
        console.log(
          `  ✓ ${data.nombre} ${data.apellido} (PIN fijo: ${passwordFija})`,
        );
      }
      ...
      if (grupo) {
        ...
        console.log(
          `  ⚠️  Grupo no encontrado: ${grupoCodigo} para ${data.nombre} ${data.apellido}`,
        );
      }
    } catch (error: any) {
      console.log(
        `  ✗ Error con ${data.nombre} ${data.apellido}: ${error.message}`,
      );
    }
  }
