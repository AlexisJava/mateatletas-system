...
-- CreateEnum
CREATE TYPE "estado_planificacion_simple" AS ENUM ('DETECTADA', 'ASIGNADA', 'ARCHIVADA');
...
CREATE TABLE "logros_cursos" (
    ...
    CONSTRAINT "logros_cursos_pkey" PRIMARY KEY ("id")
);
...
-- CreateTable
CREATE TABLE "planificaciones_simples" (
    "id" TEXT NOT NULL,
    "codigo" TEXT NOT NULL,
    "titulo" TEXT NOT NULL,
    ...
    "estado" "estado_planificacion_simple" NOT NULL DEFAULT 'DETECTADA',
    "auto_detectada" BOOLEAN NOT NULL DEFAULT true,
    "fecha_deteccion" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "ultima_actualizacion" TIMESTAMP(3) NOT NULL,

    CONSTRAINT "planificaciones_simples_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "semanas_activas" (
    ...
    CONSTRAINT "semanas_activas_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "progreso_estudiante_planificacion" (
    "id" TEXT NOT NULL,
    "estudiante_id" TEXT NOT NULL,
    "planificacion_id" TEXT NOT NULL,
    ...
    CONSTRAINT "progreso_estudiante_planificacion_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "logros_cursos_nombre_key" ON "logros_cursos"("nombre");
...
-- CreateIndex
CREATE UNIQUE INDEX "planificaciones_simples_codigo_key" ON "planificaciones_simples"("codigo");

-- CreateIndex
CREATE INDEX "planificaciones_simples_codigo_idx" ON "planificaciones_simples"("codigo");

-- CreateIndex
CREATE INDEX "planificaciones_simples_grupo_codigo_idx" ON "planificaciones_simples"("grupo_codigo");

-- CreateIndex
CREATE INDEX "planificaciones_simples_estado_idx" ON "planificaciones_simples"("estado");
...
-- CreateIndex
CREATE INDEX "semanas_activas_asignacion_id_idx" ON "semanas_activas"("asignacion_id");

-- CreateIndex
CREATE INDEX "semanas_activas_activa_idx" ON "semanas_activas"("activa");

-- CreateIndex
CREATE UNIQUE INDEX "semanas_activas_asignacion_id_numero_semana_key" ON "semanas_activas"("asignacion_id", "numero_semana");

-- CreateIndex
CREATE INDEX "progreso_estudiante_planificacion_estudiante_id_idx" ON "progreso_estudiante_planificacion"("estudiante_id");

-- CreateIndex
CREATE UNIQUE INDEX "progreso_estudiante_planificacion_estudiante_id_planificaci_key" ON "progreso_estudiante_planificacion"("estudiante_id", "planificacion_id");
...
-- AddForeignKey
ALTER TABLE "logros_desbloqueados" ADD CONSTRAINT "logros_desbloqueados_logro_id_fkey" FOREIGN KEY ("logro_id") REFERENCES "logros_cursos"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "lecciones" ADD CONSTRAINT "lecciones_logro_desbloqueable_id_fkey" FOREIGN KEY ("logro_desbloqueable_id") REFERENCES "logros_cursos"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "asignaciones_planificacion" ADD CONSTRAINT "asignaciones_planificacion_planificacion_id_fkey" FOREIGN KEY ("planificacion_id") REFERENCES "planificaciones_simples"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "semanas_activas" ADD CONSTRAINT "semanas_activas_asignacion_id_fkey" FOREIGN KEY ("asignacion_id") REFERENCES "asignaciones_planificacion"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "progreso_estudiante_planificacion" ADD CONSTRAINT "progreso_estudiante_planificacion_estudiante_id_fkey" FOREIGN KEY ("estudiante_id") REFERENCES "estudiantes"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "progreso_estudiante_planificacion" ADD CONSTRAINT "progreso_estudiante_planificacion_planificacion_id_fkey" FOREIGN KEY ("planificacion_id") REFERENCES "planificaciones_simples"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
