...
describe('PaymentAmountValidatorService - Redis Caching (PASO 3.1.B)', () => {
  ...
  // Tests de validateMembresia, validateInscripcion2026 y validatePagoInscripcion2026
  // fueron eliminados porque esos métodos fueron removidos (sistema legacy eliminado)

  /**
   * TEST 3: Cache HIT - validateColoniaPago()
   */
